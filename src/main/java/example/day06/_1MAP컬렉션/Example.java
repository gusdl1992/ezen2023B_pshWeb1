    ...
    public static void main(String[] args) {
        ...
        /*  Map 컬렉션
                ...
                - 사용방법/메소드
                    ...
                    .remove( key )          : 주어진 key 의 해당하는 엔트리 삭제
        ...
        */
        ...
        // 2.
        Set<Map.Entry<String,Integer> > entySet =  map.entrySet();
        Iterator< Map.Entry<String , Integer> > entyIterator = entySet.iterator();
        while (entyIterator.hasNext()){
            Map.Entry<String , Integer > entry = entyIterator.next();
